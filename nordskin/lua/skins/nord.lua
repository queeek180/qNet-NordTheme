...
SKIN.PrintName		= "Nord"
SKIN.Author		= "queeek180"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/nord.png" )

SKIN.text_normal				= Color( 236, 239, 244, 255 )
SKIN.text_bright				= Color( 236, 239, 244, 255 )
SKIN.text_dark					= Color( 236, 239, 244, 255 )
SKIN.colCategoryText			= Color( 236, 239, 244, 255 )
SKIN.colCategoryTextInactive	= Color( 236, 239, 244, 255 )
SKIN.colTabText					= Color( 236, 239, 244, 255 )
SKIN.colButtonText				= Color( 236, 239, 244, 255 )
SKIN.colButtonDisabled			= Color( 236, 239, 244, 255 )
SKIN.colTextEntryText			= Color( 236, 239, 244, 255 )
SKIN.colTextEntry 				= Color( 236, 239, 244, 255 )
SKIN.colTextEntryTextHighlight	= Color( 136, 192, 208, 255 )
SKIN.colTextEntryTextCursor		= Color( 236, 239, 244, 255 )
SKIN.colTextEntryTextPlaceholder= Color( 216, 222, 233, 255 )
SKIN.colMneuBG					= Color( 236, 239, 244, 255 )
...
derma.DefineSkin( "Nord", "Nordic", SKIN )


hook.Add( "ForceDermaSkin", "NordSkinForce", function()
    return "Nord"
end )
